...
def fetch_news():
    print("📡 Syncing High-Signal Intelligence...")
    all_entries = []
    ...
    <style>
        * {{ box-sizing: border-box; -webkit-tap-highlight-color: transparent; }}
        :root {{
            ...
            --nav-h: 80px; --font-main: 'Inter', sans-serif;
            --menu-bg: #ffffff;
        }}
        [data-theme="dark"] {{
        ...
        .nav-actions {{ 
            ...
            display: flex; flex-direction: column; padding: 100px 30px; gap: 18px;
        ...
        .menu-item {{ 
            padding: 15px 20px; border-radius: 12px; font-size: 14px; font-weight: 800;
            color: var(--text); background: var(--border); border: none; cursor: pointer; text-align: left;
        }}
        .filter-btn.active {{ background: var(--accent); color: white; }}
        .close-btn {{ margin-top: auto; background: var(--text); color: var(--bg); text-align: center; font-size: 16px; }}

        /* --- CONTENT --- */
        .container {{ width: 100%; max-width: 1200px; margin: 120px auto 60px; padding: 0 30px; }}
        ...
        .source-tag {{ font-size: 11px; font-weight: 800; color: var(--accent); text-transform: uppercase; margin-bottom: 8px; font-family: 'JetBrains Mono'; }}
        ...
        @media (max-width: 768px) {{
            .items {{ grid-template-columns: 1fr; gap: 35px; }}
            .container {{ margin-top: 110px; }}
            .date-center {{ font-size: 11px; }}
            .logo {{ font-size: 16px; }}
        }}
    </style>
</head>
    ...
    <nav class="nav">
        ...
        <div class="menu-wrap">
            ...
            <div class="nav-actions">
                ...
                <button class="menu-item filter-btn active" onclick="filterSource('all', this)">All Feeds</button>
                ...
                <button class="menu-item filter-btn" onclick="filterSource('Hacker News', this)">Hacker News</button>
